...
function CompletedOrder (props){
    ...
    useEffect(() => {
        orderApi.getAll().then((res) => {let filterData = res.data.filter(x => x.status === "Giao hàng thành công")
        ...
        <div>
            <section className="pageAdmin">
                ...
                <div className="order-management">
                    ...
                    <h4 className="c-grey-900 mT-10 mB-30">QUẢN LÝ ĐƠN HÀNG ĐÃ HOÀN THÀNH</h4>
                    <div className="row">
