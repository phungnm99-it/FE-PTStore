...
function AddShipperAccount(props) {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      userApi.addShipperAccount(formData).then((res) => {
        if (res.code === 401) {
          alert(
            "Thêm tài khoản thất bại! Trùng email, số điện thoại hoặc tên đăng nhập!"
          );
        } else {
...
export default AddShipperAccount;
